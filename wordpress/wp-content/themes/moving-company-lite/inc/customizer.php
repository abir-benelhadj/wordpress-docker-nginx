...
function moving_company_lite_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section( 'moving_company_lite_slidersettings' , array(
    	...
    	'description' => __('Free theme has 3 slides options, For unlimited slides and more options <a class="go-pro-btn" target="blank" href="https://www.buywptemplates.com/products/moving-company-wordpress-theme">GET PRO</a>','moving-company-lite'),
		'panel' => 'moving_company_lite_homepage_panel'
	) );
	...
	$wp_customize->add_setting('moving_company_lite_top_button_url',array(
		'default'	=> '',
		'sanitize_callback'	=> 'esc_url_raw'
	));
	$wp_customize->add_control('moving_company_lite_top_button_url',array(
		'label'	=> __('Add Button URL','moving-company-lite'),
		'section'	=> 'moving_company_lite_slidersettings',
		'setting'	=> 'moving_company_lite_top_button_url',
		'type'	=> 'url',
		'active_callback' => 'moving_company_lite_default_slider'
	));
	...
	'choices' => array(
      '0' =>  esc_attr( __('0','moving-company-lite')),
      '0.1' =>  esc_attr( __('0.1','moving-company-lite')),
      '0.2' =>  esc_attr( __('0.2','moving-company-lite')),
      '0.3' =>  esc_attr( __('0.3','moving-company-lite')),
      '0.4' =>  esc_attr( __('0.4','moving-company-lite')),
      '0.5' =>  esc_attr( __('0.5','moving-company-lite')),
      '0.6' =>  esc_attr( __('0.6','moving-company-lite')),
      '0.7' =>  esc_attr( __('0.7','moving-company-lite')),
      '0.8' =>  esc_attr( __('0.8','moving-company-lite')),
      '0.9' =>  esc_attr( __('0.9','moving-company-lite'))
	),'active_callback' => 'moving_company_lite_default_slider'
	));
	...
	$wp_customize->add_control('moving_company_lite_about_btn',array(
		'description' => "<a class='go-pro' target='_blank' href=".esc_url(MOVING_COMPANY_LITE_BUY_NOW).">More Info</a>",
		'section'=> 'moving_company_lite_about',
		'type'=> 'hidden'
	));
	...
	$wp_customize->add_section( 'moving_company_lite_services_section' , array(
    	...
    	'description' => __('For more options of service section <a class="go-pro-btn" target="blank" href="https://www.buywptemplates.com/products/moving-company-wordpress-theme">GET PRO</a>','moving-company-lite'),
		'priority'   => null,
		'panel' => 'moving_company_lite_homepage_panel'
	) );
	...
	$wp_customize->add_section('moving_company_lite_footer',array(
		...
		'description' => __('For more options of footer section <a class="go-pro-btn" target="blank" href="https://www.buywptemplates.com/products/moving-company-wordpress-theme">GET PRO</a>','moving-company-lite'),
		'panel' => 'moving_company_lite_homepage_panel',
	));	
    ...
    $wp_customize->add_control( new Moving_Company_Lite_Toggle_Switch_Custom_Control( $wp_customize, 'moving_company_lite_footer_hide_show',array(
 	...
 	// font size
	$wp_customize->add_setting('moving_company_lite_button_footer_font_size',array(
		'default'=> 25,
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('moving_company_lite_button_footer_font_size',array(
		'label'	=> __('Footer Heading Font Size','moving-company-lite'),
  		'type'        => 'number',
		'input_attrs' => array(
			'step'             => 1,
			'min'              => 1,
	...
	$wp_customize->add_setting('moving_company_lite_button_footer_heading_letter_spacing',array(
		'default'=> 1,
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('moving_company_lite_button_footer_heading_letter_spacing',array(
		'label'	=> __('Heading Letter Spacing','moving-company-lite'),
  		'type'        => 'number',
		'input_attrs' => array(
			'step'             => 1,
			'min'              => 1,
	...
	// text trasform
	$wp_customize->add_setting('moving_company_lite_button_footer_text_transform',array(
		'default'=> 'Capitalize',
		'sanitize_callback'	=> 'moving_company_lite_sanitize_choices'
	));
	$wp_customize->add_control('moving_company_lite_button_footer_text_transform',array(
		'type' => 'radio',
		'label'	=> __('Heading Text Transform','moving-company-lite'),
		'choices' => array(
      'Uppercase' => __('Uppercase','moving-company-lite'),
      'Capitalize' => __('Capitalize','moving-company-lite'),
      'Lowercase' => __('Lowercase','moving-company-lite'),
	...
	$wp_customize->add_setting('moving_company_lite_footer_heading_weight',array(
        'default' => 500,
        'transport' => 'refresh',
        'sanitize_callback' => 'moving_company_lite_sanitize_choices'
	));
	$wp_customize->add_control('moving_company_lite_footer_heading_weight',array(
        'type' => 'select',
        'label' => __('Heading Font Weight','moving-company-lite'),
        'section' => 'moving_company_lite_footer',
        'choices' => array(
        	'100' => __('100','moving-company-lite'),
            '200' => __('200','moving-company-lite'),
	...
	$wp_customize->add_setting('moving_company_lite_footer_template',array(
		'default'	=> esc_html('moving_company_lite-footer-one'),
		'sanitize_callback'	=> 'moving_company_lite_sanitize_choices'
	));
	$wp_customize->add_control('moving_company_lite_footer_template',array(
		'label'	=> esc_html__('Footer style','moving-company-lite'),
		'section'	=> 'moving_company_lite_footer',
		'setting'	=> 'moving_company_lite_footer_template',
		'type' => 'select',
		'choices' => array(
			'moving_company_lite-footer-one' => esc_html__('Style 1', 'moving-company-lite'),
			'moving_company_lite-footer-two' => esc_html__('Style 2', 'moving-company-lite'),
			'moving_company_lite-footer-three' => esc_html__('Style 3', 'moving-company-lite'),
			'moving_company_lite-footer-four' => esc_html__('Style 4', 'moving-company-lite'),
			'moving_company_lite-footer-five' => esc_html__('Style 5', 'moving-company-lite'),
		)
	));
    ...
    $wp_customize->add_setting('moving_company_lite_align_footer_social_icon',array(
        'default' => 'center',
        'sanitize_callback' => 'moving_company_lite_sanitize_choices'
	));
	$wp_customize->add_control('moving_company_lite_align_footer_social_icon',array(
        'type' => 'select',
        'label' => __('Social Icon Alignment ','moving-company-lite'),
        'section' => 'moving_company_lite_footer',
        'choices' => array(
            'left' => __('Left','moving-company-lite'),
            'right' => __('Right','moving-company-lite'),
	...
	$wp_customize->add_setting( 'moving_company_lite_related_toggle_postdate',array(
	    'default' => 1,
	    'transport' => 'refresh',
	    'sanitize_callback' => 'moving_company_lite_switch_sanitization'
  	));
  	$wp_customize->add_control( new Moving_Company_Lite_Toggle_Switch_Custom_Control( $wp_customize, 'moving_company_lite_related_toggle_postdate',array(
	    'label' => esc_html__( 'Show / Hide Post Date','moving-company-lite' ),
	    'section' => 'moving_company_lite_related_posts_settings'
  	)));

  	$wp_customize->add_setting('moving_company_lite_related_postdate_icon',array(
	    'default' => 'fas fa-calendar-alt',
	    'sanitize_callback' => 'sanitize_text_field'
  	));
  	$wp_customize->add_control(new Moving_Company_Lite_Fontawesome_Icon_Chooser(
  	$wp_customize,'moving_company_lite_related_postdate_icon',array(
	    'label' => __('Add Post Date Icon','moving-company-lite'),
	    'transport' => 'refresh',
	    'section' => 'moving_company_lite_related_posts_settings',
	    'setting' => 'moving_company_lite_related_postdate_icon',
	    'type'    => 'icon'
  	)));

	$wp_customize->add_setting( 'moving_company_lite_related_toggle_author',array(
		'default' => 1,
		'transport' => 'refresh',
		'sanitize_callback' => 'moving_company_lite_switch_sanitization'
  	));
  	$wp_customize->add_control( new Moving_Company_Lite_Toggle_Switch_Custom_Control( $wp_customize, 'moving_company_lite_related_toggle_author',array(
		'label' => esc_html__( 'Show / Hide Author','moving-company-lite' ),
		'section' => 'moving_company_lite_related_posts_settings'
  	)));

  	$wp_customize->add_setting('moving_company_lite_related_author_icon',array(
	    'default' => 'fas fa-user',
	    'sanitize_callback' => 'sanitize_text_field'
  	));
  	$wp_customize->add_control(new Moving_Company_Lite_Fontawesome_Icon_Chooser(
  	$wp_customize,'moving_company_lite_related_author_icon',array(
	    'label' => __('Add Author Icon','moving-company-lite'),
	    'transport' => 'refresh',
	    'section' => 'moving_company_lite_related_posts_settings',
	    'setting' => 'moving_company_lite_related_author_icon',
	    'type'    => 'icon'
  	)));

	$wp_customize->add_setting( 'moving_company_lite_related_toggle_comments',array(
		'default' => 1,
		'transport' => 'refresh',
		'sanitize_callback' => 'moving_company_lite_switch_sanitization'
  	) );
  	$wp_customize->add_control( new Moving_Company_Lite_Toggle_Switch_Custom_Control( $wp_customize, 'moving_company_lite_related_toggle_comments',array(
		'label' => esc_html__( 'Show / Hide Comments','moving-company-lite' ),
		'section' => 'moving_company_lite_related_posts_settings'
  	)));

  	$wp_customize->add_setting('moving_company_lite_related_comments_icon',array(
	    'default' => 'fa fa-comments',
	    'sanitize_callback' => 'sanitize_text_field'
  	));
  	$wp_customize->add_control(new Moving_Company_Lite_Fontawesome_Icon_Chooser(
  	$wp_customize,'moving_company_lite_related_comments_icon',array(
	    'label' => __('Add Comments Icon','moving-company-lite'),
	    'transport' => 'refresh',
	    'section' => 'moving_company_lite_related_posts_settings',
	    'setting' => 'moving_company_lite_related_comments_icon',
	    'type'    => 'icon'
  	)));

	$wp_customize->add_setting( 'moving_company_lite_related_toggle_time',array(
		'default' => 1,
		'transport' => 'refresh',
		'sanitize_callback' => 'moving_company_lite_switch_sanitization'
  	) );
  	$wp_customize->add_control( new Moving_Company_Lite_Toggle_Switch_Custom_Control( $wp_customize, 'moving_company_lite_related_toggle_time',array(
		'label' => esc_html__( 'Show / Hide Time','moving-company-lite' ),
		'section' => 'moving_company_lite_related_posts_settings'
  	)));

  	$wp_customize->add_setting('moving_company_lite_related_time_icon',array(
	    'default' => 'fas fa-clock',
	    'sanitize_callback' => 'sanitize_text_field'
  	));
  	$wp_customize->add_control(new Moving_Company_Lite_Fontawesome_Icon_Chooser(
  	$wp_customize,'moving_company_lite_related_time_icon',array(
	    'label' => __('Add Time Icon','moving-company-lite'),
	    'transport' => 'refresh',
	    'section' => 'moving_company_lite_related_posts_settings',
	    'setting' => 'moving_company_lite_related_time_icon',
	    'type'    => 'icon'
  	)));

  	$wp_customize->add_setting('moving_company_lite_related_post_meta_field_separator',array(
		'default'=> '|',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('moving_company_lite_related_post_meta_field_separator',array(
		'label'	=> __('Add Meta Separator','moving-company-lite'),
		'description' => __('Add the seperator for meta box. Example: "|", "/", etc.','moving-company-lite'),
		'section'=> 'moving_company_lite_related_posts_settings',
		'type'=> 'text'
	...
	$wp_customize->add_setting( 'moving_company_lite_related_image_hide_show',array(
		'default' => 1,
		'transport' => 'refresh',
		'sanitize_callback' => 'moving_company_lite_switch_sanitization'
	));
  	$wp_customize->add_control( new Moving_Company_Lite_Toggle_Switch_Custom_Control( $wp_customize, 'moving_company_lite_related_image_hide_show', array(
		'label' => esc_html__( 'Show / Hide Featured Image','moving-company-lite' ),
		'section' => 'moving_company_lite_related_posts_settings'
  	)));

  	$wp_customize->add_setting( 'moving_company_lite_related_image_box_shadow', array(
		'default'              => '0',
		'transport' 		   => 'refresh',
		'sanitize_callback'    => 'moving_company_lite_sanitize_number_range'
	) );
	$wp_customize->add_control( 'moving_company_lite_related_image_box_shadow', array(
		'label'       => esc_html__( 'Related post Image Box Shadow','moving-company-lite' ),
		'section'     => 'moving_company_lite_related_posts_settings',
		'type'        => 'range',
		'input_attrs' => array(
			'step'             => 1,
  	...
  	$wp_customize->add_setting('moving_company_lite_related_button_text',array(
		'default'=> esc_html__('Read More','moving-company-lite'),
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('moving_company_lite_related_button_text',array(
		'label'	=> esc_html__('Add Button Text','moving-company-lite'),
		'input_attrs' => array(
      'placeholder' => esc_html__( 'Read More', 'moving-company-lite' ),
        ),
		'section'=> 'moving_company_lite_related_posts_settings',
		'type'=> 'text'
	));
	...
	$wp_customize->add_setting( 'moving_company_lite_singlepost_image_box_shadow', array(
		'default'              => '0',
		'transport' 		   => 'refresh',
		'sanitize_callback'    => 'moving_company_lite_sanitize_number_range'
	) );
	$wp_customize->add_control( 'moving_company_lite_singlepost_image_box_shadow', array(
		'label'       => esc_html__( 'Single post Image Box Shadow','moving-company-lite' ),
		'section'     => 'moving_company_lite_single_blog_settings',
		'type'        => 'range',
		'input_attrs' => array(
			'step'             => 1,
    ...
    $wp_customize->add_setting( 'moving_company_lite_grid_image_hide_show',array(
		'default' => 1,
		'transport' => 'refresh',
		'sanitize_callback' => 'moving_company_lite_switch_sanitization'
	));
  	$wp_customize->add_control( new Moving_Company_Lite_Toggle_Switch_Custom_Control( $wp_customize, 'moving_company_lite_grid_image_hide_show', array(
		'label' => esc_html__( 'Show / Hide Featured Image','moving-company-lite' ),
		'section' => 'moving_company_lite_grid_layout_settings'
  	)));

	$wp_customize->add_setting('moving_company_lite_grid_meta_field_separator',array(
		'default'=> '|',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('moving_company_lite_grid_meta_field_separator',array(
		'label'	=> __('Add Meta Separator','moving-company-lite'),
		'description' => __('Add the seperator for meta box. Example: "|", "/", etc.','moving-company-lite'),
		'section'=> 'moving_company_lite_grid_layout_settings',
		'type'=> 'text'
    ...
    $wp_customize->add_setting('moving_company_lite_display_grid_posts_settings',array(
        'default' => 'Into Blocks',
        'transport' => 'refresh',
        'sanitize_callback' => 'moving_company_lite_sanitize_choices'
	));
	$wp_customize->add_control('moving_company_lite_display_grid_posts_settings',array(
        'type' => 'select',
        'label' => __('Display Grid Posts','moving-company-lite'),
        'section' => 'moving_company_lite_grid_layout_settings',
        'choices' => array(
        	'Into Blocks' => __('Into Blocks','moving-company-lite'),
            'Without Blocks' => __('Without Blocks','moving-company-lite')
	...
	$wp_customize->add_setting('moving_company_lite_grid_button_text',array(
		'default'=> esc_html__('Read More','moving-company-lite'),
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('moving_company_lite_grid_button_text',array(
		'label'	=> esc_html__('Add Button Text','moving-company-lite'),
		'input_attrs' => array(
            'placeholder' => esc_html__( 'Read More', 'moving-company-lite' ),
        ),
	...
	$wp_customize->add_setting('moving_company_lite_grid_excerpt_suffix',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('moving_company_lite_grid_excerpt_suffix',array(
		'label'	=> __('Add Excerpt Suffix','moving-company-lite'),
		'input_attrs' => array(
            'placeholder' => __( '[...]', 'moving-company-lite' ),
        ),
    ...
    $wp_customize->add_setting('moving_company_lite_grid_excerpt_settings',array(
        'default' => 'Excerpt',
        'transport' => 'refresh',
        'sanitize_callback' => 'moving_company_lite_sanitize_choices'
	));
	$wp_customize->add_control('moving_company_lite_grid_excerpt_settings',array(
        'type' => 'select',
        'label' => esc_html__('Grid Post Content','moving-company-lite'),
        'section' => 'moving_company_lite_grid_layout_settings',
        'choices' => array(
        	'Content' => esc_html__('Content','moving-company-lite'),
            'Excerpt' => esc_html__('Excerpt','moving-company-lite'),
            'No Content' => esc_html__('No Content','moving-company-lite')
        ),
	) );

	$wp_customize->add_setting( 'moving_company_lite_grid_featured_image_border_radius', array(
		'default'              => '0',
		'transport' 		   => 'refresh',
		'sanitize_callback'    => 'moving_company_lite_sanitize_number_range'
	) );
	$wp_customize->add_control( 'moving_company_lite_grid_featured_image_border_radius', array(
		'label'       => esc_html__( 'Grid Featured Image Border Radius','moving-company-lite' ),
		'section'     => 'moving_company_lite_grid_layout_settings',
		'type'        => 'range',
		'input_attrs' => array(
			'step'             => 1,
	...
	$wp_customize->add_setting( 'moving_company_lite_grid_featured_image_box_shadow', array(
		'default'              => '0',
		'transport' 		   => 'refresh',
		'sanitize_callback'    => 'moving_company_lite_sanitize_number_range'
	) );
	$wp_customize->add_control( 'moving_company_lite_grid_featured_image_box_shadow', array(
		'label'       => esc_html__( 'Grid Featured Image Box Shadow','moving-company-lite' ),
		'section'     => 'moving_company_lite_grid_layout_settings',
		'type'        => 'range',
		'input_attrs' => array(
			'step'             => 1,
   ...
   // other settings
	...
	$wp_customize->add_setting('moving_company_lite_breadcrumbs_alignment',array(
        'default' => 'Left',
        'sanitize_callback' => 'moving_company_lite_sanitize_choices'
	));
	$wp_customize->add_control('moving_company_lite_breadcrumbs_alignment',array(
        'type' => 'select',
        'label' => __('Breadcrumbs Alignment','moving-company-lite'),
        'section' => 'moving_company_lite_left_right',
        'choices' => array(
            'Left' => __('Left','moving-company-lite'),
            'Right' => __('Right','moving-company-lite'),
    ...
    $wp_customize->add_setting( 'moving_company_lite_responsive_preloader_hide',array(
        'default' => false,
        'transport' => 'refresh',
        'sanitize_callback' => 'moving_company_lite_switch_sanitization'
    ) );
    $wp_customize->add_control( new Moving_Company_Lite_Toggle_Switch_Custom_Control( $wp_customize, 'moving_company_lite_responsive_preloader_hide',array(
        'label' => esc_html__( 'Show / Hide Preloader','moving-company-lite' ),
        'section' => 'moving_company_lite_responsive_media'
    )));
	...
	*/
	public function sections( $manager ) {
		...
		$manager->add_section( new Moving_Company_Lite_Customize_Section_Pro( $manager,'moving_company_lite_upgrade_pro_link', array(
			...
			'pro_url'  => esc_url('https://www.buywptemplates.com/products/moving-company-wordpress-theme'),
		) )	);
		...
		$manager->add_section(new Moving_Company_Lite_Customize_Section_Pro($manager,'moving_company_lite_get_started_link',array(
			...
			'pro_url'  => esc_url('https://demos.buywptemplates.com/demo/docs/free-moving-company-lite/'),
		)));
	}

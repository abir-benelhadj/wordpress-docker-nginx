...
if ( ! class_exists( 'Moving_Company_Lite_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Moving_Company_Lite_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'moving_company_lite_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function moving_company_lite_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Moving_Company_Lite_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_styles();
	}
}

if ( ! function_exists( 'moving_company_lite_wptt_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function moving_company_lite_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new Moving_Company_Lite_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}

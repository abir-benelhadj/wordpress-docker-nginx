...
* Add show / hide scroll top option in customizer
...
= 0.4 =
* Resolved admin sticky header error.
...
* Remove SmoothScroll js file.

= 0.4.1 =
* Resolved mobile menu close button & admin bar sticky header error.
* Done slider box sec css of block pattern in responsive media.
...
* Added toggle button color option in customizer. 
* Added logo padding option in customizer.
* Added logo margin option in customizer.
* Updated language folder.

= 0.7 =
* Added go pro button in services and footer settings in customizer.
* Removed menus and toggle button default color from customizer.
...
* Added blog page button font size, text transform padding and border radius in customizer.
* Updated language folder. 
...
* Added default about us button text in customizer.
* Update language folder.  
...
= 0.8.3 =
* Resolved css error of block pattern.
...
* Resolved error for tag in single blog post. 
...
* Added classes in global color.
* Resolved blog post meta field seperator error in single post.
* Added meta separator option in grid layout settings.
...
* Resolved error for email hover color.
* Resolved error for block pattern.

= 0.9.2 =
* Added slider button url option in slider setting.
* Resolved slider css error in responsive media.

= 0.9.3 =
* Added grid post button text option in grid layout settings.
* Added grid post excerpt suffix option in grid layout settings.
...
= 0.9.6 =
* Resolved our services section condition.
* Resolved slider button condition.
* Resolved footer css in tablet responsive media.
* Added link in By VWThemes text for copyright.
...
* Change demo link in get started.

= 0.9.9 =
* Updated link of buy now and free url.
...
= 1.0.7 =
* Update get started.
* Added breadcrumbs alignment option.
...
= 1.1.7 =
* Resolved error for show/hide preloader.
* Updated pot file.

== Resources ==

Moving Company Lite WordPress Theme, Copyright 2019 VWthemes
Moving Company Lite is distributed under the terms of the GNU GPL.
...
== Fonts ==
* Nunito+Sans *
* Source : https://fonts.google.com/specimen/Nunito+Sans?query=Nunito+Sans

* Stylish *
* Source : https://fonts.google.com/specimen/Stylish?query=Stylish
...
License: CC0 1.0 Universal (CC0 1.0)
Source: https://pxhere.com/en/photo/1070638

* All the icons taken from genericons licensed under GPL License.
http://genericons.com/

== Theme Documentation ==
Documentation : https://demos.buywptemplates.com/demo/docs/free-moving-company-lite/
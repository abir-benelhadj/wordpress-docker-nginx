<?php
	...
	if($moving_company_lite_second_color != false){
		$moving_company_lite_custom_css .='.wp-block-woocommerce-cart .wc-block-cart__submit-button:hover, .wc-block-components-checkout-place-order-button:hover{';
			$moving_company_lite_custom_css .='color: '.esc_attr($moving_company_lite_second_color).'!important;';
		$moving_company_lite_custom_css .='}';
	}
	if($moving_company_lite_second_color != false){
	...
	$moving_company_lite_button_letter_spacing = get_theme_mod('moving_company_lite_button_letter_spacing');
	$moving_company_lite_custom_css .='.post-main-box .more-btn a{';
	...
	$moving_company_lite_display_grid_posts_settings = get_theme_mod( 'moving_company_lite_display_grid_posts_settings','Into Blocks');
    if($moving_company_lite_display_grid_posts_settings == 'Without Blocks'){
		$moving_company_lite_custom_css .='.grid-post-main-box{';
			$moving_company_lite_custom_css .='box-shadow: none; border: none; margin:30px 0;';
		$moving_company_lite_custom_css .='}';
	}

	$moving_company_lite_grid_featured_image_border_radius = get_theme_mod('moving_company_lite_grid_featured_image_border_radius', 0);
	if($moving_company_lite_grid_featured_image_border_radius != false){
		$moving_company_lite_custom_css .='.grid-post-main-box .box-image img, .grid-post-main-box .feature-box img{';
			$moving_company_lite_custom_css .='border-radius: '.esc_attr($moving_company_lite_grid_featured_image_border_radius).'px;';
		$moving_company_lite_custom_css .='}';
	}

	$moving_company_lite_grid_featured_image_box_shadow = get_theme_mod('moving_company_lite_grid_featured_image_box_shadow',0);
	if($moving_company_lite_grid_featured_image_box_shadow != false){
		$moving_company_lite_custom_css .='.grid-post-main-box .box-image img, .grid-post-main-box .feature-box img, #content-vw img{';
			$moving_company_lite_custom_css .='box-shadow: '.esc_attr($moving_company_lite_grid_featured_image_box_shadow).'px '.esc_attr($moving_company_lite_grid_featured_image_box_shadow).'px '.esc_attr($moving_company_lite_grid_featured_image_box_shadow).'px #cccccc;';
		$moving_company_lite_custom_css .='}';
	}

	$moving_company_lite_singlepost_image_box_shadow = get_theme_mod('moving_company_lite_singlepost_image_box_shadow',0);
	if($moving_company_lite_singlepost_image_box_shadow != false){
		$moving_company_lite_custom_css .='.single-post .feature-box img{';
			$moving_company_lite_custom_css .='box-shadow: '.esc_attr($moving_company_lite_singlepost_image_box_shadow).'px '.esc_attr($moving_company_lite_singlepost_image_box_shadow).'px '.esc_attr($moving_company_lite_singlepost_image_box_shadow).'px #cccccc;';
		$moving_company_lite_custom_css .='}';
	}

	$moving_company_lite_related_image_box_shadow = get_theme_mod('moving_company_lite_related_image_box_shadow',0);
	if($moving_company_lite_related_image_box_shadow != false){
		$moving_company_lite_custom_css .='.related-post .box-image img{';
			$moving_company_lite_custom_css .='box-shadow: '.esc_attr($moving_company_lite_related_image_box_shadow).'px '.esc_attr($moving_company_lite_related_image_box_shadow).'px '.esc_attr($moving_company_lite_related_image_box_shadow).'px #cccccc;';
		$moving_company_lite_custom_css .='}';
	}
	...
	$moving_company_lite_resp_slider = get_theme_mod( 'moving_company_lite_resp_slider_hide_show',true);
	...
	if($moving_company_lite_copyright_alignment != false){
		$moving_company_lite_custom_css .='.copyright p,#footer-2 p{';
	...
	$moving_company_lite_align_footer_social_icon = get_theme_mod('moving_company_lite_align_footer_social_icon');
	if($moving_company_lite_align_footer_social_icon != false){
		$moving_company_lite_custom_css .='.copyright .widget{';
			$moving_company_lite_custom_css .='text-align: '.esc_attr($moving_company_lite_align_footer_social_icon).';';
		$moving_company_lite_custom_css .='}';
		$moving_company_lite_custom_css .='
		@media screen and (max-width:720px) {
			.copyright .widget{';
	...
	if($moving_company_lite_footer_background_image != false){
		$moving_company_lite_custom_css .='#footer{';
			$moving_company_lite_custom_css .='background: url('.esc_attr($moving_company_lite_footer_background_image).');background-size:cover;';
		$moving_company_lite_custom_css .='}';
	}
	...
	$moving_company_lite_button_footer_heading_letter_spacing = get_theme_mod('moving_company_lite_button_footer_heading_letter_spacing',1);
	$moving_company_lite_custom_css .='#footer h3, #footer .wp-block-search .wp-block-search__label, a.rsswidget.rss-widget-title{';
		$moving_company_lite_custom_css .='letter-spacing: '.esc_attr($moving_company_lite_button_footer_heading_letter_spacing).'px;';
	$moving_company_lite_custom_css .='}';

	$moving_company_lite_button_footer_font_size = get_theme_mod('moving_company_lite_button_footer_font_size','25');
	$moving_company_lite_custom_css .='#footer h3, #footer .wp-block-search .wp-block-search__label, a.rsswidget.rss-widget-title{';
		$moving_company_lite_custom_css .='font-size: '.esc_attr($moving_company_lite_button_footer_font_size).'px;';
	$moving_company_lite_custom_css .='}';

	$moving_company_lite_theme_lay = get_theme_mod( 'moving_company_lite_button_footer_text_transform','Capitalize');
	if($moving_company_lite_theme_lay == 'Capitalize'){
		$moving_company_lite_custom_css .='#footer h3, #footer .wp-block-search .wp-block-search__label{';
			$moving_company_lite_custom_css .='text-transform:Capitalize;';
		$moving_company_lite_custom_css .='}';
	...
	$moving_company_lite_footer_heading_weight = get_theme_mod('moving_company_lite_footer_heading_weight','500');
	if($moving_company_lite_footer_heading_weight != false){
		$moving_company_lite_custom_css .='#footer h3, #footer .wp-block-search .wp-block-search__label, a.rsswidget.rss-widget-title{';
			$moving_company_lite_custom_css .='font-weight: '.esc_attr($moving_company_lite_footer_heading_weight).';';
		$moving_company_lite_custom_css .='}';
	}

	/*---------------------------Footer Style -------------------*/

	$moving_company_lite_theme_lay = get_theme_mod( 'moving_company_lite_footer_template','moving_company_lite-footer-one');
    if($moving_company_lite_theme_lay == 'moving_company_lite-footer-one'){
		$moving_company_lite_custom_css .='#footer{';
			$moving_company_lite_custom_css .='';
		$moving_company_lite_custom_css .='}';

	}else if($moving_company_lite_theme_lay == 'moving_company_lite-footer-two'){
		$moving_company_lite_custom_css .='#footer{';
			$moving_company_lite_custom_css .='background: linear-gradient(to right, #f9f8ff, #dedafa);';
		$moving_company_lite_custom_css .='}';
		$moving_company_lite_custom_css .='#footer p, #footer li a, #footer, #footer h3, #footer a.rsswidget, #footer #wp-calendar a, .copyright a, #footer .custom_details, #footer ins span, #footer .tagcloud a, .main-inner-box span.entry-date a, nav.woocommerce-MyAccount-navigation ul li:hover a, #footer ul li a, #footer table, #footer th, #footer td, #footer caption, #sidebar caption,#footer nav.wp-calendar-nav a,#footer .search-form .search-field{';
			$moving_company_lite_custom_css .='color:#000;';
		$moving_company_lite_custom_css .='}';
		$moving_company_lite_custom_css .='#footer ul li::before{';
			$moving_company_lite_custom_css .='background:#000;';
		$moving_company_lite_custom_css .='}';
		$moving_company_lite_custom_css .='#footer table, #footer th, #footer td,#footer .search-form .search-field,#footer .tagcloud a{';
			$moving_company_lite_custom_css .='border: 1px solid #000;';
		$moving_company_lite_custom_css .='}';

	}else if($moving_company_lite_theme_lay == 'moving_company_lite-footer-three'){
		$moving_company_lite_custom_css .='#footer{';
			$moving_company_lite_custom_css .='background: #232524;';
		$moving_company_lite_custom_css .='}';
	}
	else if($moving_company_lite_theme_lay == 'moving_company_lite-footer-four'){
		$moving_company_lite_custom_css .='#footer{';
			$moving_company_lite_custom_css .='background: #f7f7f7;';
		$moving_company_lite_custom_css .='}';
		$moving_company_lite_custom_css .='#footer p, #footer li a, #footer, #footer h3, #footer a.rsswidget, #footer #wp-calendar a, .copyright a, #footer .custom_details, #footer ins span, #footer .tagcloud a, .main-inner-box span.entry-date a, nav.woocommerce-MyAccount-navigation ul li:hover a, #footer ul li a, #footer table, #footer th, #footer td, #footer caption, #sidebar caption,#footer nav.wp-calendar-nav a,#footer .search-form .search-field{';
			$moving_company_lite_custom_css .='color:#000;';
		$moving_company_lite_custom_css .='}';
	...
	else if($moving_company_lite_theme_lay == 'moving_company_lite-footer-five'){
		$moving_company_lite_custom_css .='#footer{';
			$moving_company_lite_custom_css .='background: linear-gradient(to right, #01093a, #2d0b00);';
		$moving_company_lite_custom_css .='}';
	}

	$moving_company_lite_responsive_preloader_hide = get_theme_mod('moving_company_lite_responsive_preloader_hide',false);
	if($moving_company_lite_responsive_preloader_hide == true && get_theme_mod('moving_company_lite_loader_enable',false) == false){
		$moving_company_lite_custom_css .='@media screen and (min-width:575px){
			#preloader{';
			$moving_company_lite_custom_css .='display:none !important;';
		$moving_company_lite_custom_css .='} }';
	}

	if($moving_company_lite_responsive_preloader_hide == false){
		$moving_company_lite_custom_css .='@media screen and (max-width:575px){
			#preloader{';
			$moving_company_lite_custom_css .='display:none !important;';
		$moving_company_lite_custom_css .='} }';
	...
	$moving_company_lite_breadcrumbs_alignment = get_theme_mod( 'moving_company_lite_breadcrumbs_alignment','Left');
    if($moving_company_lite_breadcrumbs_alignment == 'Left'){
    	$moving_company_lite_custom_css .='@media screen and (min-width:768px) {';
		$moving_company_lite_custom_css .='.breadcrumbs{';
			$moving_company_lite_custom_css .='text-align:start;';
		$moving_company_lite_custom_css .='}}';
	}else if($moving_company_lite_breadcrumbs_alignment == 'Center'){
		$moving_company_lite_custom_css .='@media screen and (min-width:768px) {';
		$moving_company_lite_custom_css .='.breadcrumbs{';
			$moving_company_lite_custom_css .='text-align:center;';
		$moving_company_lite_custom_css .='}}';
	}else if($moving_company_lite_breadcrumbs_alignment == 'Right'){
		$moving_company_lite_custom_css .='@media screen and (min-width:768px) {';
		$moving_company_lite_custom_css .='.breadcrumbs{';
			$moving_company_lite_custom_css .='text-align:end;';
		$moving_company_lite_custom_css .='}}';
	}
